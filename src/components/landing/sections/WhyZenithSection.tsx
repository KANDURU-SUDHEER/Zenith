  ...
  return (
    <SectionWrapper id="about" tight className="pb-8 md:pb-12" bleedColor="rgba(6,3,15,0.6)">
      <FadeUp className="mx-auto text-center">
        ...
        <p
          className="mt-4 break-words text-[0.82rem] leading-[1.8] text-[#80a888] md:text-[0.88rem]"
      ...
      <div className="mt-10 grid gap-5 md:grid-cols-2">
        <FadeUp delay={0.1}>
          <div className="relative overflow-hidden rounded-3xl border border-red-500/15 bg-red-500/[0.03] p-5 sm:p-8">
            <div className="mb-6 flex items-center gap-3">
              ...
              <div className="min-w-0">
                <div className="break-words text-base font-bold text-white">Traditional Space Sites</div>
            ...
            <ul className="space-y-3">
              {OLD.map((item, i) => (
                <motion.li key={item}
                  ...
                  className="flex items-start gap-3 break-words text-sm text-[#6a8870]">
        ...
        <FadeUp delay={0.2}>
          <div className="relative overflow-hidden rounded-3xl border border-[#00e676]/20 bg-[#00e676]/[0.04] p-5 sm:p-8">
            ...
            <div className="mb-6 flex items-center gap-3">
              <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full border border-[#00e676]/30 bg-[#00e676]/15">
                <Check className="h-5 w-5 text-[#00e676]" />
              </div>
              <div className="min-w-0">
                <div className="break-words text-base font-bold text-white">Project Zenith</div>
            ...
            <ul className="space-y-3">
              {NEW.map((item, i) => (
                <motion.li key={item}
                  ...
                  viewport={{ once: true }}
                  transition={{ delay: 0.15+i*0.05, duration: 0.45, ease: [0.16,1,0.3,1] }}
                  className="flex items-start gap-3 break-words text-sm text-[#a0b8a8]">
